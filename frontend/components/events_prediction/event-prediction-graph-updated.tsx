...
const EventPredictionGraph = ({
      ...
      return [
        {
          ...
          description: "Quarterly rebalancing of your portfolio",
          x: 100,
          y: 100,
          happened: true,
        },
        {
          ...
          description: "Received dividend payments",
          x: 400,
          y: 150,
          happened: true,
        },
        {
          id: "3",
          title: "Stock Split",
          description: "Major stock in your portfolio split 4:1",
          x: 200,
          y: 300,
          happened: true,
        },
        {
          ...
          description: "Potential tax implications for gains",
          x: 500,
          y: 400,
          happened: false,
        },
        {
          ...
          description: "Several holdings report earnings next week",
          x: 300,
          y: 500,
          happened: false,
        },
      ...
      return [
        {
          id: "1",
          title: "Market Crash",
          description: "Stock market crashed by 5%",
          x: 100,
          y: 100,
          happened: true,
        },
        {
          ...
          description: "Central bank raised interest rates",
          x: 400,
          y: 150,
          happened: true,
        },
        {
          ...
          description: "Major tech company files for bankruptcy",
          x: 200,
          y: 300,
          happened: true,
        },
        {
          ...
          description: "Currency loses 10% of its value",
          x: 500,
          y: 400,
          happened: false,
        },
        {
          id: "5",
          title: "Mass Layoffs",
          description: "Unemployment rises across sectors",
          x: 300,
          y: 500,
          happened: false,
        },
        {
          ...
          description: "Property values drop by 15%",
          x: 700,
          y: 300,
          happened: false,
        },
  ...
  const adjustEventsForTimePeriod = (events: Event[], period: string) => {
    ...
    if (period === "day") {
      ...
      if (modifiedEvents.length > 0) {
        modifiedEvents[0] = {
          ...modifiedEvents[0],
          title: `${period.charAt(0).toUpperCase() + period.slice(1)}ly ${
            modifiedEvents[0].title
          }`,
  ...
  return (
    ...
    >
      ...
      >
        {dataSource === "personal" ? "Portfolio" : "Market"} Event Prediction
        Network ({timePeriod})
      </h1>
          ...
          <defs>
            ...
            >
              <feDropShadow
                ...
                dy="3"
                stdDeviation="4"
                floodColor="rgba(249, 115, 22, 0.3)"
              />
            </filter>
          </defs>
            ...
            return (
              <g
                ...
                className={`transition-opacity duration-1000 ${
                  isPrediction ? "opacity-80" : "opacity-100"
                }`}
              >
                {/* Line between events */}
                <line
            ...
            return (
              ...
              >
                ...
                <rect
                  ...
                  rx="8"
                  fill={
                    event.happened ? "rgb(37, 99, 235)" : "rgb(249, 115, 22)"
                  }
                  fillOpacity={isPredicted ? "0.85" : "1"}
                  filter={
                    event.happened
                      ? "url(#shadow-happened)"
                      : "url(#shadow-predicted)"
                  }
